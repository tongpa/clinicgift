# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in clinicgift.
...
import clinicgift
from clinicgift import model, lib
...
base_config.package = clinicgift
...
base_config.model = clinicgift.model
base_config.DBSession = clinicgift.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "da18a542-f087-4ae5-adbe-0181cabf9c88"
